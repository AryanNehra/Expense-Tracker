  ...
  const handleSubmit = (e) => {
    ...
    if (isEditing) {
      setExpenses(expenses.map(exp => 
        exp._id === editId ? { ...form, _id: editId } : exp
      ));
      setIsEditing(false);
      setEditId(null);
    } else {
    ...
    <div className="min-h-screen bg-gray-50 p-4 md:p-8">
      ...
      <header className="mb-8">
        <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
          <div>
            <h1 className="text-3xl font-bold text-gray-800">Expense Tracker Demo</h1>
            <p className="text-gray-600">Try out our expense tracking features</p>
          </div>
      ...
      <div className="bg-yellow-100 text-yellow-800 p-4 rounded-lg mb-8">
        <p className="text-center">
          ⚠️ This is a demo version. Your changes will not be saved permanently.
        </p>
      </div>
          ...
          <div className="flex flex-col md:flex-row md:items-center gap-6 mb-6">
            ...
            <div className="flex-1">
              ...
              <div className="w-full bg-gray-200 rounded-full h-3 overflow-hidden">
                <div
                  className={`h-full ${
                    budgetWarningLevel === 'critical' ? 'bg-red-500' :
              ...
              <div className="flex justify-between mt-1">
                <span className={`text-xs font-medium ${
                  budgetWarningLevel === 'critical' ? 'text-red-500' :
